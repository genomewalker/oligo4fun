...
In the following example, we use the _acsA_ (acetyl-coenzyme A synthetase) gene data from _Rhodopirellula_ species used in Zure et al. 2016 used to perform a Minimum Entropy Decomposition ([MED](http://merenlab.org/projects/med/)) analysis, the unsupervised flavour of [oligotyping](http://merenlab.org/projects/oligotyping/).
