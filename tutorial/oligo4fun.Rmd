...
In the following examples, data which are loaded togther with the library, are used to perform a Minimum Entropy Decomposition ([MED](http://merenlab.org/projects/med/)) analysis, the unsupervised flavour of [oligotyping](http://merenlab.org/projects/oligotyping/).
...
aln
```
One can read any fasta file using read.dna function from [ape package](https://cran.r-project.org/web/packages/ape/index.html):
